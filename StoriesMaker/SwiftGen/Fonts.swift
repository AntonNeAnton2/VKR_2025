...
internal enum FontFamily {
  ...
  internal enum HennyPenny {
    internal static let regular = FontConvertible(name: "HennyPenny-Regular", family: "Henny Penny", path: "HennyPenny-Regular.ttf")
  ...
  internal enum MrCountryhouseG {
    internal static let regular = FontConvertible(name: "mr_CountryhouseG", family: "mr_CountryhouseG", path: "Сountryhouse.ttf")
    internal static let all: [FontConvertible] = [regular]
  }
  internal static let allCustomFonts: [FontConvertible] = [Gilroy.all, HennyPenny.all, Montserrat.all, MrCountryhouseG.all].flatMap { $0 }
